...
layout = html.Div([
    ...
    html.Div([
        html.Div([
            html.Div([dcc.Graph(id="my-graph-binance")], className="row", style={"margin": "auto"}),
    ...
    html.Br(),
    html.Div(id='response-binance', children='Click to predict trend',
...
@app.callback(Output('response-binance', 'children'), [Input('my-button', 'n_clicks')])
...
@app.callback(
    Output("my-graph-binance", 'figure'),
